...
<Tabs>
  ...
  <TabItem value="macos" label="MacOS">
      <p>
          Download the latest launcher version for MacOS as a .dmg from the <a href="/downloads">downloads page</a>.
          Open the dmg file and move Lilith to your Applications folder. You can now start Lilith like any other application.
      </p>
  </TabItem>
