...
<Tabs>
  ...
  <TabItem value="macos" label="MacOS">
      <p>
          Download the latest launcher version for MacOS from the <a href="/downloads">downloads page</a>.
          Unzip the folder, right click on the app that is extracted, and click Open to start Lilith.
      </p>
  </TabItem>
